...
public class ReportConfigUtil {
    ...
    public static JasperPrint fillReport(File reportFile, Map<String, Object> parameters, Connection beanCollection) throws JRException {
        JasperPrint jasperPrint = JasperFillManager.fillReport(reportFile.getPath(), parameters, beanCollection);
        return jasperPrint;
    }
    
        public static JasperPrint fillReport(File reportFile, Map<String, Object> parameters) throws JRException {
