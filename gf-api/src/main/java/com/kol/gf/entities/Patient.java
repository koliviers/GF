...
public class Patient implements Serializable {
    ...
    public Patient(Long id, String nomPatient, String prenomPatient, int age, char sexe, long contact, String civilite, String profession, String adresse, double taille, double poid, double tourtaille, double tension, String sport, String fruit, String antMedicaux, String antChirugicaux, Pathologie pathologie, List<Consultation> listConsultation, List<RendezVous> listRdv) {
        this.id = id;
